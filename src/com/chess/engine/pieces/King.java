...
public class King extends Piece {
    ...
    private static final boolean isFirstColumnException(int currentPosition, int candidateOffset){
        return BoardUtils.FIRST_COLUMN[currentPosition] && candidateOffset == -9 || candidateOffset == -1 || candidateOffset == 7;
    }

    private static final boolean isEighthColumnException(int currentPosition, int candidateOffset){
